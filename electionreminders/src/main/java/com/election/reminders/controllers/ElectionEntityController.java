...
public class ElectionEntityController {
    ...
    @PostMapping("/addEntityName")
    public List<ElectionEntity> addEntityName(@RequestBody List<ElectionEntity> electionEntityWithNewInfo) {
        logger.info("Updating election entities");
        return electionEntityRepository.saveAll(electionEntityWithNewInfo);
    }
}
